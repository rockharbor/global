				...
				<ul class="campus-list campus-chooser">
					<li>
						...
						<div class="campus-info">
							...
							<div class="service-times"><?php echo do_shortcode('[service-times campus="9"]'); ?></div>
						</div>
					</li>
					<li>
						...
						<div class="campus-info">
							...
							<div class="service-times"><?php echo do_shortcode('[service-times campus="6"]'); ?></div>
						</div>
					</li>
					<li>
						...
						<div class="campus-info">
							...
							<div class="service-times"><?php echo do_shortcode('[service-times campus="5"]'); ?></div>
						</div>
					</li>
					<li>
						...
						<div class="campus-info">
							...
							<div class="service-times"><?php echo do_shortcode('[service-times campus="7"]'); ?></div>
						</div>
					</li>
					<li>
						...
						<div class="campus-info">
							...
							<div class="service-times"><?php echo do_shortcode('[service-times campus="8"]'); ?></div>
						</div>
					</li>
				</ul>
			</article>
